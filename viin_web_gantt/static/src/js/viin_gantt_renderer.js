    ...
    var ViinGanttRenderer = AbstractRenderer.extend({
        ...
        */
        getValueFromTaskRow: function(task_row, updateSequence) {
            ...
            if (!state_data_task || state_data_task[start_date_field] != moment.utc(start_datetime.getTime()).format(self.date_field_sql_format)) {
                data_task[start_date_field] = moment.utc(start_datetime.getTime()).format(self.date_field_sql_format);
            }
            if (!state_data_task || state_data_task[stop_date_field] != moment.utc(end_datetime.getTime()).format(self.date_field_sql_format)) {
                data_task[stop_date_field] = moment.utc(end_datetime.getTime()).format(self.date_field_sql_format);
            }
